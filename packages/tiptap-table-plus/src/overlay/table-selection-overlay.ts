...
import { getTablePlusTranslations } from '../table-plus';
...
export const TableSelectionOverlay = Extension.create(() => {
  ...
  function destroyOverlay() {
    ...
    const menu = document.querySelector('.tiptap-table-plus-context-menu');
    if (menu) menu.remove();
  }
