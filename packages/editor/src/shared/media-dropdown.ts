...
const DROPDOWN_CLASS = 'easyx-editor-media-dropdown';
const TABS_CLASS = 'easyx-editor-media-dropdown-tabs';
const TAB_CLASS = 'easyx-editor-media-dropdown-tab';
const PANEL_CLASS = 'easyx-editor-media-dropdown-panel';
const UPLOAD_BTN_CLASS = 'easyx-editor-media-dropdown-upload-btn';
const UPLOAD_HINT_CLASS = 'easyx-editor-media-dropdown-upload-hint';
const UPLOAD_PROGRESS_CLASS = 'easyx-editor-media-dropdown-upload-progress';
const URL_ROW_CLASS = 'easyx-editor-media-dropdown-url-row';
const URL_INPUT_CLASS = 'easyx-editor-media-dropdown-url-input';
const URL_INSERT_BTN_CLASS = 'easyx-editor-media-dropdown-url-insert-btn';
const SEARCH_ROW_CLASS = 'easyx-editor-media-dropdown-search-row';
const SEARCH_INPUT_CLASS = 'easyx-editor-media-dropdown-search-input';
const SEARCH_BTN_CLASS = 'easyx-editor-media-dropdown-search-btn';
const GRID_CLASS = 'easyx-editor-media-dropdown-grid';
const ITEM_CLASS = 'easyx-editor-media-dropdown-item';
const ITEM_THUMB_CLASS = 'easyx-editor-media-dropdown-item-thumb';
const ITEM_INFO_CLASS = 'easyx-editor-media-dropdown-item-info';
const ITEM_NAME_CLASS = 'easyx-editor-media-dropdown-item-name';
const ITEM_SIZE_CLASS = 'easyx-editor-media-dropdown-item-size';
const PAGINATION_CLASS = 'easyx-editor-media-dropdown-pagination';
const PAGE_BTN_CLASS = 'easyx-editor-media-dropdown-page-btn';
const PAGE_INFO_CLASS = 'easyx-editor-media-dropdown-page-info';
const STATUS_CLASS = 'easyx-editor-media-dropdown-status';
